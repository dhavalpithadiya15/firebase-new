  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      case RoutesGenerator.splash:
        return MaterialPageRoute(builder: (context) => BlocProvider(create: (context) => SplashCubit(),child: const SplashView(),
          ),
        );
      case RoutesGenerator.onBoard:
        return MaterialPageRoute(
          builder: (context) => BlocProvider(create: (context) => OnBoardCubit(), child: const OnBoardView(),
          ),
        );
      case RoutesGenerator.login:return MaterialPageRoute(builder: (context) => const LoginView());
