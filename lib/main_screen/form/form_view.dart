...
>>>>>>> third commit
                      ...
                      CustomPhoneTextField(
                        onChangeCountryCode: (value) =>
                            BlocProvider.of<MyFormCubit>(context).onChangeCountryCode(value),
                        ...
                        builder: (context, state) {
                          return CSCPicker(
                            ...
                            dropdownHeadingStyle:
                                const TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.bold),
                      ...
                      CustomTextField(
                          ...
                          controller: context.read<MyFormCubit>().state.pinCodeController),
                      const SizedBox(
                        height: 10,
                      ),
                      Align(
